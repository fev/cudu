...
cudu.ui.datatable.buildQuery = function(queryColumnas, campoOrden, orden, inicio, resultados, filtros) {
	...
	+ '&i=' + inicio
	+ '&r=' + resultados 
	+ '&f_asociacion=' + filtros.asociacion
};
...
cudu.filtrarPor = {
	asociacion: function() {
		if (YAHOO.util.Dom.hasClass(cudu.dom.ctrlAsociacionCualquiera, 'selected')) {
			cudu.dom.tabla.filtros.asociacion = '';
		} else {
			var asociaciones= [];
			if (YAHOO.util.Dom.hasClass(cudu.dom.chkAsociacionsdA, 'selected')) 
                            asociaciones.push('SdA');
                        if (YAHOO.util.Dom.hasClass(cudu.dom.chkAsociacionMEV, 'selected')) 
                            asociaciones.push('MEV');
			if (YAHOO.util.Dom.hasClass(cudu.dom.chkAsociacionsdC, 'selected')) 
                            asociaciones.push('SdC');  
                        
                        cudu.dom.tabla.filtros.asociacion = asociaciones.join(',');
		}
		cudu.dom.tabla.reload();
	}
};
