...
Para generar el `frontend` necesitas tener instalado [Node.js](https://nodejs.org). Puedes obtener todas las dependencias y levantar un servidor de desarrollo fácilmente mediante:
