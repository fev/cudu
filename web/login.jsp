...
body { color: #333; background: #9bdbf7 url('<c:url value="/theme/img/bg.jpg" />') repeat-x 0 0;
...
input.button.save { padding-left:30px; padding-right:8px; font-family:'Trebuchet MS',Arial,Helvetica,sans-serif;
    background: transparent url('<c:url value="/theme/img/tango/tick32.png" />') no-repeat 5px 2px; width: 100px }
  ...
  <div class="yui-g">
    ...
    <div class="yui-g" style="background: transparent url('<c:url value="/theme/img/onepix40.png" />;')">
      ...
      <form action="j_spring_security_check">
        <div>
          <label for="http://localhost:8080/cudu/login.jsp">Usuario</label>
        ...
        <div style="text-align: right">
          ...
          <input type="submit" class="button save" value="Entrar" />       
        </div>
      </form>
      </div>
    </div>
