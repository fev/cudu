...
CREATE TABLE pagocuotas (
  ...
  CONSTRAINT pk_pagocuotas PRIMARY KEY (idgrupo, "a�o"),
  CONSTRAINT fk_pagocuotas_grupo FOREIGN KEY (idgrupo)
      REFERENCES grupo (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT "pagocuotas_a�o_check" CHECK ("a�o" >= 0)
);


-- Datos de prueba
insert into grupo (id, nombre, calle, numero, codigoPostal, idProvincia, idMunicipio, mail, asociacion)
values ('AK','Ain-Karen', 'Diputado Llu�s Lucia', 21, 46015, 46, 250, 'ainkaren@gmail.com', 1);

insert into pagocuotas (idgrupo, "a�o", cantidad)
