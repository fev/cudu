...
public interface AsociadoStorage {
    SparseTable listado(Asociacion asociacion, String grupoId, TipoAsociado tipo, List<String> ramas, Boolean inactivo, String sexo, String nombreApellido, String orden, Boolean ordenAsc, Pageable pageable);
