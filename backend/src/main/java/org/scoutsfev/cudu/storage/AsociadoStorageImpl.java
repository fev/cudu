...
public class AsociadoStorageImpl implements AsociadoStorage {
    ...
    private final static Field[] camposListado = {
        ...
        ASOCIADO.CERTIFICADO_DELITOS_SEXUALES, ASOCIADO.CERTIFICADO_VOLUNTARIADO, ASOCIADO.CURSO_PROTECCION_INFANCIA, ASOCIADO.COMPROMISO_CERTIFICADO_INFANCIA
    };
    ...
    @Override
    public SparseTable listado(Asociacion asociacion, String grupoId, TipoAsociado tipo, List<String> ramas, Boolean inactivos, String genero, String nombreApellido, String orden, Boolean ordenAsc, Boolean certificadoDelitosSexuales, Boolean certificadoVoluntariado, Boolean cursoProteccionInfancia, Pageable pageable, Boolean compromisoCertificadoInfancia) {
        ...
        if (compromisoCertificadoInfancia != null) base = base.and(ASOCIADO.COMPROMISO_CERTIFICADO_INFANCIA.eq(compromisoCertificadoInfancia));
    ...
    @Override
    public int contador(Asociacion asociacion, String grupoId, TipoAsociado tipo, List<String> ramas, Boolean inactivos,
                        String genero, String nombreApellido, Boolean certificadoDelitosSexuales, Boolean certificadoVoluntariado,
                        Boolean cursoProteccionInfancia, Boolean compromisoCertificadoInfancia ) {
