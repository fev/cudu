...
public class LiquidacionBalanceRecord extends TableRecordImpl<LiquidacionBalanceRecord> implements Record10<String, Short, Integer, Long, Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal> {

	private static final long serialVersionUID = -1449195684;
	 ...
	 */
	@Override
	public Row10<String, Short, Integer, Long, Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal> fieldsRow() {
	 ...
	 */
	@Override
	public Row10<String, Short, Integer, Long, Long, BigDecimal, BigDecimal, BigDecimal, BigDecimal, BigDecimal> valuesRow() {
	 ...
	 */
	@Override
	public LiquidacionBalanceRecord values(String value1, Short value2, Integer value3, Long value4, Long value5, BigDecimal value6, BigDecimal value7, BigDecimal value8, BigDecimal value9, BigDecimal value10) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public LiquidacionBalanceRecord(String grupoId, Short rondaId, Integer liquidacionId, Long activos, Long diferencia, BigDecimal precioUnitario, BigDecimal subtotal, BigDecimal ajusteManual, BigDecimal pagado, BigDecimal balance) {
		super(LiquidacionBalance.LIQUIDACION_BALANCE);
