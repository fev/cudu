...
import org.scoutsfev.cudu.db.tables.records.CursoRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<ActividadRecord, GrupoRecord> ACTIVIDAD__ACTIVIDAD_GRUPO_ID_FKEY = createForeignKey(org.scoutsfev.cudu.db.Keys.PK_GRUPO, Actividad.ACTIVIDAD, Actividad.ACTIVIDAD.GRUPO_ID);
		public static final ForeignKey<AsistenteActividadRecord, ActividadRecord> ASISTENTE_ACTIVIDAD__ASISTENTE_ACTIVIDAD_ACTIVIDAD_ID_FKEY = createForeignKey(org.scoutsfev.cudu.db.Keys.ACTIVIDAD_PKEY, AsistenteActividad.ASISTENTE_ACTIVIDAD, AsistenteActividad.ASISTENTE_ACTIVIDAD.ACTIVIDAD_ID);
		public static final ForeignKey<AsistenteActividadRecord, AsociadoRecord> ASISTENTE_ACTIVIDAD__ASISTENTE_ACTIVIDAD_ASOCIADO_ID_FKEY = createForeignKey(org.scoutsfev.cudu.db.Keys.PK_ASOCIADO, AsistenteActividad.ASISTENTE_ACTIVIDAD, AsistenteActividad.ASISTENTE_ACTIVIDAD.ASOCIADO_ID);
		public static final ForeignKey<AsociadoRecord, GrupoRecord> ASOCIADO__FK_ASOCIADO_GRUPO = createForeignKey(org.scoutsfev.cudu.db.Keys.PK_GRUPO, Asociado.ASOCIADO, Asociado.ASOCIADO.GRUPO_ID);
		public static final ForeignKey<CursoRecord, AsociadoRecord> CURSO__FK_CURSO_COORDINADORID_ASOCIADO = createForeignKey(org.scoutsfev.cudu.db.Keys.PK_ASOCIADO, Curso.CURSO, Curso.CURSO.COORDINADOR_ID);
		public static final ForeignKey<CursoFormadorRecord, CursoRecord> CURSO_FORMADOR__FK_CURSO_FORMADOR_CURSO = createForeignKey(org.scoutsfev.cudu.db.Keys.PK_CURSO, CursoFormador.CURSO_FORMADOR, CursoFormador.CURSO_FORMADOR.CURSO_ID);
