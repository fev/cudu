...
public class AsociadoRecord extends UpdatableRecordImpl<AsociadoRecord> {
	...
	private static final long serialVersionUID = -1655045471;
	...
	public AsociadoRecord(Integer id, String tipo, String grupoId, String nombre, String apellidos, String sexo, Date fechaNacimiento, String dni, String seguridadSocial, Boolean certificadoDelitosSexuales, Boolean tieneSeguroPrivado, String direccion, Integer codigoPostal, String telefonoCasa, String telefonoMovil, String email, String municipio, Boolean tieneTutorLegal, Boolean padresDivorciados, String padreNombre, String padreTelefono, String padreEmail, String madreNombre, String madreTelefono, String madreEmail, Timestamp fechaAlta, Timestamp fechaBaja, Timestamp fechaActualizacion, Boolean ramaColonia, Boolean ramaManada, Boolean ramaExploradores, Boolean ramaExpedicion, Boolean ramaRuta, Boolean activo, Boolean usuarioActivo, String password, Boolean requiereCaptcha, String lenguaje, String ambitoEdicion, Integer restriccionAsociacion, Boolean noPuedeEditarDatosDelGrupo, Boolean noPuedeEditarOtrasRamas, Boolean soloLectura, String estudios, String profesion, Boolean hermanosEnElGrupo, Timestamp fechaUsuarioCreado, Timestamp fechaUsuarioVisto, Integer usuarioCreadoPorId, String usuarioCreadoPorNombre, String notas, String emailContacto, Short calidadPassword) {
		...
		setValue(9, certificadoDelitosSexuales);
		setValue(10, tieneSeguroPrivado);
		setValue(11, direccion);
		setValue(12, codigoPostal);
		setValue(13, telefonoCasa);
		setValue(14, telefonoMovil);
		setValue(15, email);
		setValue(16, municipio);
		setValue(17, tieneTutorLegal);
		setValue(18, padresDivorciados);
		setValue(19, padreNombre);
		setValue(20, padreTelefono);
		setValue(21, padreEmail);
		setValue(22, madreNombre);
		setValue(23, madreTelefono);
		setValue(24, madreEmail);
		setValue(25, fechaAlta);
		setValue(26, fechaBaja);
		setValue(27, fechaActualizacion);
		setValue(28, ramaColonia);
		setValue(29, ramaManada);
		setValue(30, ramaExploradores);
		setValue(31, ramaExpedicion);
		setValue(32, ramaRuta);
		setValue(33, activo);
		setValue(34, usuarioActivo);
		setValue(35, password);
		setValue(36, requiereCaptcha);
		setValue(37, lenguaje);
		setValue(38, ambitoEdicion);
		setValue(39, restriccionAsociacion);
		setValue(40, noPuedeEditarDatosDelGrupo);
		setValue(41, noPuedeEditarOtrasRamas);
		setValue(42, soloLectura);
		setValue(43, estudios);
		setValue(44, profesion);
		setValue(45, hermanosEnElGrupo);
		setValue(46, fechaUsuarioCreado);
		setValue(47, fechaUsuarioVisto);
		setValue(48, usuarioCreadoPorId);
		setValue(49, usuarioCreadoPorNombre);
		setValue(50, notas);
		setValue(51, emailContacto);
		setValue(52, calidadPassword);
	}
}
