...
public class AuthorizationServicePuedeEditarAsociadoTests {

    private AuthorizationService service;
    private AsociadoParaAutorizar asociado;
    ...
    public void no_permite_si_el_asociado_es_nulo() throws Exception {
        assertFalse(service.puedeEditarAsociado((AsociadoParaAutorizar)null, usuario));
    }

    @Test
    public void no_permite_si_el_usuario_es_nulo() throws Exception {
        assertFalse(service.puedeEditarAsociado(asociado, null));
    }

    @Test
    public void no_permite_si_el_usuario_y_el_asociado_son_nulos() throws Exception {
        assertFalse(service.puedeEditarAsociado((AsociadoParaAutorizar)null, null));
    }
    ...
    public void no_permite_si_el_usuario_no_esta_activo() throws Exception {
        ...
        assertFalse(service.puedeEditarAsociado(asociado, usuario));
    }

    @Test
    public void permite_editar_sus_propios_datos_cuando_viene_de_grupo_y_tiene_restricciones_solo_lectura() throws Exception {
        ...
        assertTrue(service.puedeEditarAsociado(asociado, usuario));
    }

    @Test
    public void permite_editar_sus_propios_datos_cuando_es_tecnico_asociativo() throws Exception {
    ...
    @Test
    public void permite_editar_sus_propios_datos_cuando_es_tecnico_asociativo_y_tiene_restriccion_de_solo_lectura() throws Exception {
        when(usuario.getTipo()).thenReturn(TipoAsociado.Tecnico);
        when(usuario.getAmbitoEdicion()).thenReturn(AmbitoEdicion.Asociacion);
    ...
    @Test
    public void permite_editar_sus_propios_datos_cuando_es_tecnico_federativo() throws Exception {
        when(usuario.getTipo()).thenReturn(TipoAsociado.Tecnico);
    ...
    @Test
    public void permite_editar_sus_propios_datos_cuando_es_tecnico_federativo_y_tiene_restriccion_de_solo_lectura() throws Exception {
        when(usuario.getTipo()).thenReturn(TipoAsociado.Tecnico);
        when(usuario.getAmbitoEdicion()).thenReturn(AmbitoEdicion.Federacion);
        Restricciones restricciones = new Restricciones();
        restricciones.setSoloLectura(true);
    ...
    @Test
    public void permite_editar_sus_propios_datos_con_cualquier_otro_tipo_de_asociado() throws Exception {
    ...
    @Test
    public void permite_editar_sus_propios_datos_con_cualquier_ambito_de_edicion() throws Exception {
    ...
    @Test
    public void no_permite_si_el_usuario_esta_marcado_como_solo_lectura() throws Exception {
        prepararCasoMismoGrupoSinRestricciones();
        Restricciones restricciones = new Restricciones();
        restricciones.setSoloLectura(true);
        when(usuario.getRestricciones()).thenReturn(restricciones);
    ...
    @Test
    public void no_permite_si_el_usuario_esta_marcado_como_solo_lectura_aun_siendo_tecnico_federativo() throws Exception {
