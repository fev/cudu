...
IMAGE_NAME=nexus.jamgo.org:5000/jamgocoop/cudu-frontend
DOCKER_BUILDKIT=1 docker build --no-cache --rm --progress=plain --file ./Dockerfile --tag $IMAGE_NAME:latest ../..
