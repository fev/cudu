...
traducciones.factory('Traducciones', ['$http', 'CuduEtc', function($http, CuduEtc) {
  var ca = {
    ...
    'activar.emailDuplicado': 'Ja existeix un usuari amb aquest email a la base de dades.',
    'activar.errorServidor': 'S\'ha produït un error en el servidor.',
    'asociado.nuevoNombre': '(nou)',
    'asociado.sinPermisosRama': 'L\'associat està en una branca que no pots editar. Només pot estar en: ',
    ...
    'cargo.fev.colaborador_lluerna': 'Col·laborador de l\'Escola Lluerna',
  ...
  var es = {
    ...
    'activar.emailDuplicado': 'Ya existe un usuario con ese email en la base de datos.',
    'activar.errorServidor': 'Se ha producido un error en el servidor.',
    'asociado.nuevoNombre': '(nuevo)',
    'asociado.sinPermisosRama': 'El asociado está en una rama que no puedes editar. Sólo puede estar en: ',
    ...
    'cargo.fev.colaborador_lluerna': 'Colaborador de Escola Lluerna',
