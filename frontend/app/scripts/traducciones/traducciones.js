...
traducciones.factory('Traducciones', ['$http', 'CuduEtc', function($http, CuduEtc) {
  var ca = {
    ...
    'impresion.novisibles': 'No hi ha cap associat visible',
    'impresion.titulo.listadoCompleto':'Llistat complet d\'associats - ',
    'impresion.titulo.listadoVisiblesJoves':'Llistat filtrat de Joves - ',
    'impresion.titulo.listadoVisiblesKraal':'Llistat filtrat de Kraal - ',
    'impresion.titulo.listadoVisiblesComite':'Llistat filtrat de Comitè - ',
    'impresion.titulo.listadoVisiblesOtro':'Llistat filtrat - ',
    'formulario.errorRecuperar':'Recorda GUARDAR els canvis abans de RECUPERAR.',
  ...
  var es = {
    ...
    'impresion.novisibles': 'No hay ningún asociado visible',
    'impresion.titulo.listadoCompleto':'Listado completo de asociados - ',
    'impresion.titulo.listadoVisiblesJoves':'Listado filtrado de Jóvenes - ',
    'impresion.titulo.listadoVisiblesKraal':'Listado filtrado de Kraal - ',
    'impresion.titulo.listadoVisiblesComite':'Listado filtrado de Comité - ',
    'impresion.titulo.listadoVisiblesOtro':'Listado filtrado - ',
    'formulario.errorRecuperar':'Recuerda GUARDAR los cambios antes de RECUPERAR.',
